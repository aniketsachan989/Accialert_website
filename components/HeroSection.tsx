...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-16 lg:py-24">
      ...
      <div className="absolute top-20 right-10 w-[400px] h-[400px] bg-emerald-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-slate-900/90 border border-red-500/30 text-xs font-semibold text-red-400 shadow-lg shadow-red-950/40">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
              </span>
              <span className="tracking-wide uppercase text-[11px] text-slate-200">
                AcciAlert Emergency Safety System
              </span>
              <span className="bg-gradient-to-r from-red-600 to-rose-600 text-white font-bold text-[10px] px-2 py-0.5 rounded-full shadow-sm">
                v5.0 Active
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-red-600 via-red-600 to-rose-700 hover:from-red-500 hover:to-rose-600 border border-red-400/50 shadow-xl shadow-red-950/60 transition-all hover:scale-105 active:scale-95 group"
              >
              ...
              <a
                href="#simulator"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-4 rounded-xl text-sm font-semibold text-slate-300 bg-slate-900/80 hover:bg-slate-800 hover:text-white border border-slate-800 hover:border-slate-700 transition-all"
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-slate-800/80 max-w-2xl mx-auto lg:mx-0">
              <div className="bg-slate-900/60 rounded-xl p-3.5 border border-slate-800">
                <div className="text-xl sm:text-2xl font-extrabold text-white font-mono">Instant</div>
              ...
              <div className="bg-slate-900/60 rounded-xl p-3.5 border border-slate-800">
                <div className="text-xl sm:text-2xl font-extrabold text-amber-400 font-mono">20 Sec</div>
                <div className="text-xs text-slate-400 mt-0.5 flex items-center gap-1">
              ...
              <div className="bg-slate-900/60 rounded-xl p-3.5 border border-slate-800">
                <div className="text-xl sm:text-2xl font-extrabold text-emerald-400 font-mono">Auto SMS</div>
                <div className="text-xs text-slate-400 mt-0.5 flex items-center gap-1">
              ...
              <div className="bg-slate-900/60 rounded-xl p-3.5 border border-slate-800">
                <div className="text-xl sm:text-2xl font-extrabold text-cyan-400 font-mono">15 km</div>
                <div className="text-xs text-slate-400 mt-0.5 flex items-center gap-1">
